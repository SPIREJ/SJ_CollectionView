...
{
    return _delegateFlags.didRespondColumnCount ? [self.delegate columnCountOfWaterFallLayout:self] : DefaultColumnCount;
}
...
- (CGFloat)rowMargin
{
    return _delegateFlags.didRespondColumnCount ? [self.delegate rowMarginOfWaterFallLayout:self] : DefaultRowMargin;
}
